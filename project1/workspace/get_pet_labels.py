...
def get_pet_labels(image_dir):
    ...
    for filename in filename_list:
        ...
        for split in splitted_filename:
            if any(char.isdigit() for char in split):
                index_of_split = splitted_filename.index(split)
                splitted_filename.pop(index_of_split)
        pet_label = " ".join(splitted_filename)
        pet_labels.append(pet_label.lower())
